...
class ParController extends Controller
{
    ...
    protected function validatePar(Request $request, $id = null)
    {
        $rules = [
            ...
            'variable' => 'nullable|string|max:5',
        ...
        $messages = [
            ...
            'variable.string' => 'El número variable debe ser una cadena de texto.',
            'variable.max' => 'La plataforma no puede tener más de 5 caracteres.',
