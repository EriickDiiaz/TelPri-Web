...
<div class="container">
        ...
        <form action="{{ url('callcenters/' .$callcenter->id) }}" method="post">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-5">
                    <input type="text" class="form-control" name="nombres" id="nombres" value="{{ $callcenter->nombres }}" required>
                </div>
            </div>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-5">
                    <input type="text" class="form-control" name="usuario" id="usuario" value="{{ $callcenter->usuario }}" required>
                </div>
            </div>
