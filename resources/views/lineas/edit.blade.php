@extends('layouts.app')
@section('title', 'Lineas | Editar Linea')
@section('content')
...
<div class="container">
        ...
        <div class="mb-3 row">
            <label for="modificado_por" class="col-sm-2 col-form-label">Modificado por:</label>
            <div class="col-sm-5">
                <input type="text" class="form-control" name="modificado_por" id="modificado_por" value="{{ Auth::user()->name }}" readonly>
            </div>
        </div>
